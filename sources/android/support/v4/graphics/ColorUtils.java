    ...
    public static void RGBToXYZ(@IntRange(from = 0, to = 255) int i, @IntRange(from = 0, to = 255) int i2, @IntRange(from = 0, to = 255) int i3, @NonNull double[] dArr) {
        ...
        if (dArr2.length == 3) {
            ...
            if (d9 < 0.04045d) {
                ...
                d = Math.pow((d9 + 0.055d) / 1.055d, 2.4d);
            }
            dArr2[0] = ((0.4124d * d4) + (0.3576d * d7) + (0.1805d * d)) * XYZ_WHITE_REFERENCE_Y;
            dArr2[1] = ((0.2126d * d4) + (0.7152d * d7) + (0.0722d * d)) * XYZ_WHITE_REFERENCE_Y;
            dArr2[2] = ((d4 * 0.0193d) + (d7 * 0.1192d) + (d * 0.9505d)) * XYZ_WHITE_REFERENCE_Y;
            return;
        }
