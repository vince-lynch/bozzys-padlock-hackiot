...
public final class PrintHelper {
    ...
    private static class PrintHelperImpl<RealHelper extends PrintHelperKitkat> implements PrintHelperVersionImpl {
        ...
        public void printBitmap(String str, Bitmap bitmap, final OnPrintFinishCallback onPrintFinishCallback) {
            this.mPrintHelper.printBitmap(str, bitmap, (android.support.v4.print.PrintHelperKitkat.OnPrintFinishCallback) onPrintFinishCallback != null ? new android.support.v4.print.PrintHelperKitkat.OnPrintFinishCallback() {
        ...
        public void printBitmap(String str, Uri uri, final OnPrintFinishCallback onPrintFinishCallback) throws FileNotFoundException {
            this.mPrintHelper.printBitmap(str, uri, (android.support.v4.print.PrintHelperKitkat.OnPrintFinishCallback) onPrintFinishCallback != null ? new android.support.v4.print.PrintHelperKitkat.OnPrintFinishCallback() {
                public void onFinish() {
                    onPrintFinishCallback.onFinish();
                }
            } : null);
