...
public interface IMediaSession extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMediaSession {
        ...
        /* JADX WARNING: type inference failed for: r2v28, types: [android.os.Bundle] */
        /* JADX WARNING: type inference failed for: r2v30, types: [android.os.Bundle] */
        /* JADX WARNING: type inference failed for: r2v31, types: [android.support.v4.media.MediaDescriptionCompat] */
        /* JADX WARNING: type inference failed for: r2v33, types: [android.support.v4.media.MediaDescriptionCompat] */
        /* JADX WARNING: type inference failed for: r2v34, types: [android.support.v4.media.MediaDescriptionCompat] */
        /* JADX WARNING: type inference failed for: r2v36, types: [android.support.v4.media.MediaDescriptionCompat] */
        /* JADX WARNING: type inference failed for: r2v37, types: [android.support.v4.media.MediaDescriptionCompat] */
        /* JADX WARNING: type inference failed for: r2v39, types: [android.support.v4.media.MediaDescriptionCompat] */
            ...
            if (i != 1598968902) {
                ...
                switch (i) {
                    ...
                    case 2:
                        parcel.enforceInterface(DESCRIPTOR);
                        if (parcel.readInt() != 0) {
                            r2 = (KeyEvent) KeyEvent.CREATOR.createFromParcel(parcel);
                        }
                        boolean sendMediaButton = sendMediaButton(r2);
                        parcel2.writeNoException();
                    ...
                    case 14:
                        ...
                        playFromMediaId(readString2, r2);
                        parcel2.writeNoException();
                        return true;
                    case 15:
                        parcel.enforceInterface(DESCRIPTOR);
                    ...
                    case 25:
                        parcel.enforceInterface(DESCRIPTOR);
                        if (parcel.readInt() != 0) {
                            r2 = (RatingCompat) RatingCompat.CREATOR.createFromParcel(parcel);
                        }
                        rate(r2);
                        parcel2.writeNoException();
                        return true;
                    case 26:
                        ...
                        sendCustomAction(readString4, r2);
                        parcel2.writeNoException();
                        return true;
                    case 27:
                        parcel.enforceInterface(DESCRIPTOR);
                    ...
                    case 34:
                        ...
                        prepareFromMediaId(readString5, r2);
                        parcel2.writeNoException();
                        return true;
                    case 35:
                        parcel.enforceInterface(DESCRIPTOR);
                        ...
                        prepareFromSearch(readString6, r2);
                        parcel2.writeNoException();
                        return true;
                    case 36:
                        parcel.enforceInterface(DESCRIPTOR);
                    ...
                    case 38:
                        ...
                        parcel2.writeNoException();
                        parcel2.writeInt(isShuffleModeEnabled);
                        return true;
                    case 39:
                        parcel.enforceInterface(DESCRIPTOR);
                    ...
                    case 41:
                        parcel.enforceInterface(DESCRIPTOR);
                        if (parcel.readInt() != 0) {
                            r2 = (MediaDescriptionCompat) MediaDescriptionCompat.CREATOR.createFromParcel(parcel);
                        }
                        addQueueItem(r2);
                        parcel2.writeNoException();
                        return true;
                    case 42:
                        ...
                        addQueueItemAt(r2, parcel.readInt());
                        parcel2.writeNoException();
                        return true;
                    case 43:
                        parcel.enforceInterface(DESCRIPTOR);
