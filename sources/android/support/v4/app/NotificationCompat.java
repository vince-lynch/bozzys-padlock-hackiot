...
public class NotificationCompat {
    ...
    public static class Action extends android.support.v4.app.NotificationCompatBase.Action {
        ...
        public static final Factory FACTORY = new Factory() {
            public android.support.v4.app.NotificationCompatBase.Action build(int i, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle, RemoteInput[] remoteInputArr, boolean z) {
                Action action = new Action(i, charSequence, pendingIntent, bundle, (RemoteInput[]) remoteInputArr, z);
                return action;
            }
        ...
        public static final class Builder {
            ...
            public Action build() {
                Action action = new Action(this.mIcon, this.mTitle, this.mIntent, this.mExtras, this.mRemoteInputs != null ? (RemoteInput[]) this.mRemoteInputs.toArray(new RemoteInput[this.mRemoteInputs.size()]) : null, this.mAllowGeneratedReplies);
                return action;
            }
        }
    ...
    static class NotificationCompatImplApi20 extends NotificationCompatImplKitKat {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            ...
            android.support.v4.app.NotificationCompatApi20.Builder builder4 = new android.support.v4.app.NotificationCompatApi20.Builder(builder2.mContext, builder2.mNotification, builder.resolveTitle(), builder.resolveText(), builder2.mContentInfo, builder2.mTickerView, builder2.mNumber, builder2.mContentIntent, builder2.mFullScreenIntent, builder2.mLargeIcon, builder2.mProgressMax, builder2.mProgress, builder2.mProgressIndeterminate, builder2.mShowWhen, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mPeople, builder2.mExtras, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey, builder2.mContentView, builder2.mBigContentView);
    ...
    static class NotificationCompatImplApi21 extends NotificationCompatImplApi20 {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            ...
            android.support.v4.app.NotificationCompatApi21.Builder builder4 = new android.support.v4.app.NotificationCompatApi21.Builder(builder2.mContext, builder2.mNotification, builder.resolveTitle(), builder.resolveText(), builder2.mContentInfo, builder2.mTickerView, builder2.mNumber, builder2.mContentIntent, builder2.mFullScreenIntent, builder2.mLargeIcon, builder2.mProgressMax, builder2.mProgress, builder2.mProgressIndeterminate, builder2.mShowWhen, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mCategory, builder2.mPeople, builder2.mExtras, builder2.mColor, builder2.mVisibility, builder2.mPublicVersion, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey, builder2.mContentView, builder2.mBigContentView, builder2.mHeadsUpContentView);
    ...
    static class NotificationCompatImplJellybean extends NotificationCompatImplBase {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            ...
            android.support.v4.app.NotificationCompatJellybean.Builder builder4 = new android.support.v4.app.NotificationCompatJellybean.Builder(builder2.mContext, builder2.mNotification, builder.resolveTitle(), builder.resolveText(), builder2.mContentInfo, builder2.mTickerView, builder2.mNumber, builder2.mContentIntent, builder2.mFullScreenIntent, builder2.mLargeIcon, builder2.mProgressMax, builder2.mProgress, builder2.mProgressIndeterminate, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mExtras, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey, builder2.mContentView, builder2.mBigContentView);
    ...
    static class NotificationCompatImplKitKat extends NotificationCompatImplJellybean {
        ...
        public Notification build(Builder builder, BuilderExtender builderExtender) {
            ...
            android.support.v4.app.NotificationCompatKitKat.Builder builder4 = new android.support.v4.app.NotificationCompatKitKat.Builder(builder2.mContext, builder2.mNotification, builder.resolveTitle(), builder.resolveText(), builder2.mContentInfo, builder2.mTickerView, builder2.mNumber, builder2.mContentIntent, builder2.mFullScreenIntent, builder2.mLargeIcon, builder2.mProgressMax, builder2.mProgress, builder2.mProgressIndeterminate, builder2.mShowWhen, builder2.mUseChronometer, builder2.mPriority, builder2.mSubText, builder2.mLocalOnly, builder2.mPeople, builder2.mExtras, builder2.mGroupKey, builder2.mGroupSummary, builder2.mSortKey, builder2.mContentView, builder2.mBigContentView);
