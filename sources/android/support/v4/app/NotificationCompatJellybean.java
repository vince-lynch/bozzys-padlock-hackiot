                ...
                if (actionObjectsLocked != null) {
                    ...
                    if (extras != null) {
                        ...
                        if (sparseParcelableArray != null) {
                            ...
                            Action readAction = readAction(factory, factory2, sActionIconField.getInt(obj), (CharSequence) sActionTitleField.get(obj), (PendingIntent) sActionIntentField.get(obj), bundle);
                            return readAction;
                        }
                    }
                    bundle = null;
                    Action readAction2 = readAction(factory, factory2, sActionIconField.getInt(obj), (CharSequence) sActionTitleField.get(obj), (PendingIntent) sActionIntentField.get(obj), bundle);
                    return readAction2;
                }
            } catch (IllegalAccessException e) {
