...
public class SlidingPaneLayout extends ViewGroup {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:117:0x020b  */
        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.height == -2) {
                    i13 = MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE);
                } else if (layoutParams.height == -1) {
                    i13 = MeasureSpec.makeMeasureSpec(i3, 1073741824);
                } else {
                ...
                if (mode2 == Integer.MIN_VALUE && measuredHeight > i14) {
                    i14 = Math.min(measuredHeight, i3);
                }
                i15 -= measuredWidth;
                boolean z3 = i15 < 0;
                            ...
                            if (layoutParams2.weight > 0.0f) {
                                if (layoutParams2.width != 0) {
                                    ...
                                    if (!z2) {
                                        ...
                                        i6 = i18;
                                        childAt2.measure(MeasureSpec.makeMeasureSpec(i7 + ((int) ((layoutParams2.weight * ((float) Math.max(0, i15))) / f)), 1073741824), i8);
                                        i19++;
                                        i18 = i6;
                                        i5 = 8;
                                    }
            ...
            if ((isLayoutRtlSupport ? layoutParams.rightMargin : layoutParams.leftMargin) <= 0) {
                ...
                for (int i = 0; i < childCount; i++) {
                    ...
                    if (childAt != this.mSlideableView) {
                        ...
                        int i3 = i2 - ((int) ((1.0f - f) * ((float) this.mParallaxBy)));
                        if (isLayoutRtlSupport) {
                            i3 = -i3;
                        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x0062, code lost:
        if (android.support.v4.view.ViewCompat.canScrollHorizontally(r13, isLayoutRtlSupport() ? r15 : -r15) != false) goto L_0x0066;
     */
