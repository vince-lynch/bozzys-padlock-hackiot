...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent, NestedScrollingChild, ScrollingView {
                    ...
                    if (this.mIsBeingDragged) {
                        ...
                        if (!dispatchNestedScroll(0, scrollY2, 0, i4 - scrollY2, this.mScrollOffset)) {
                            if (z2) {
                                ...
                                int i5 = scrollY + i4;
                                if (i5 < 0) {
                                    this.mEdgeGlowTop.onPull(((float) i4) / ((float) getHeight()), motionEvent2.getX(findPointerIndex) / ((float) getWidth()));
                                    if (!this.mEdgeGlowBottom.isFinished()) {
                                        this.mEdgeGlowBottom.onRelease();
                                    }
                                } else if (i5 > i3) {
                                    this.mEdgeGlowBottom.onPull(((float) i4) / ((float) getHeight()), 1.0f - (motionEvent2.getX(findPointerIndex) / ((float) getWidth())));
    ...
    /* JADX WARNING: Removed duplicated region for block: B:38:0x0061  */
    /* JADX WARNING: Removed duplicated region for block: B:41:0x007d A[ADDED_TO_REGION] */
