...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
    ...
    private void showMenu(@NonNull MenuBuilder menuBuilder) {
        ...
        if (view != null) {
            ...
            int i = (this.mDropDownGravity & 5) == 5 ? z ? horizontalOffset + measureIndividualMenuWidth : horizontalOffset - view.getWidth() : z ? horizontalOffset + view.getWidth() : horizontalOffset - measureIndividualMenuWidth;
