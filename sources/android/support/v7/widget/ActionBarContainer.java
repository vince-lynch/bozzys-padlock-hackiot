    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.mActionBarView != null) {
            ...
            if (!(this.mTabContainer == null || this.mTabContainer.getVisibility() == 8 || mode == 1073741824)) {
                ...
                setMeasuredDimension(getMeasuredWidth(), Math.min(i3 + getMeasuredHeightWithMargins(this.mTabContainer), mode == Integer.MIN_VALUE ? MeasureSpec.getSize(i2) : ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED));
            }
        }
    }
