        ...
        if (!shouldLayout(this.mNavButtonView)) {
            ...
            if (!shouldLayout || shouldLayout2) {
                ...
                if (i18 != 48) {
                    ...
                    i19 = max;
                    if (i28 < layoutParams3.topMargin + this.mTitleMarginTop) {
                        i28 = layoutParams3.topMargin + this.mTitleMarginTop;
                    } else {
                        int i29 = (((height - paddingBottom) - i9) - i28) - paddingTop;
                        if (i29 < layoutParams3.bottomMargin + this.mTitleMarginBottom) {
                            i28 = Math.max(0, i28 - ((layoutParams4.bottomMargin + this.mTitleMarginBottom) - i29));
                        }
                    }
                    i20 = paddingTop + i28;
                } else {
                ...
                if (!z3) {
                    ...
                    if (shouldLayout2) {
                        ...
                        int i31 = i20 + layoutParams6.topMargin;
                        this.mSubtitleTextView.layout(i7 - this.mSubtitleTextView.getMeasuredWidth(), i31, i7, this.mSubtitleTextView.getMeasuredHeight() + i31);
                    ...
                    int i33 = i21 - iArr[i13];
                    max = i19 + Math.max(i13, i33);
                    iArr[i13] = Math.max(i13, -i33);
                    if (shouldLayout) {
                        ...
                        i20 = measuredHeight2 + layoutParams7.bottomMargin;
                    } else {
                        i22 = max;
                    }
                    if (shouldLayout2) {
                        LayoutParams layoutParams8 = (LayoutParams) this.mSubtitleTextView.getLayoutParams();
                        int i34 = i20 + layoutParams8.topMargin;
                    ...
                    for (i16 = 0; i16 < size2; i16++) {
                        i7 = layoutChildRight((View) this.mTempViews.get(i16), i7, iArr, i36);
                    }
                    addCustomViewsWithGravity(this.mTempViews, 1);
                    int viewListMeasuredWidth = getViewListMeasuredWidth(this.mTempViews, iArr);
                    i17 = (i12 + (((i10 - i12) - i8) / 2)) - (viewListMeasuredWidth / 2);
                    int i37 = viewListMeasuredWidth + i17;
                    if (i17 >= i14) {
                        i14 = i37 > i7 ? i17 - (i37 - i7) : i17;
                    }
                    size3 = this.mTempViews.size();
                    while (i13 < size3) {
                        i14 = layoutChildLeft((View) this.mTempViews.get(i13), i14, iArr, i36);
                        i13++;
                    }
            ...
            int i372 = viewListMeasuredWidth2 + i17;
            if (i17 >= i14) {
            }
            size3 = this.mTempViews.size();
            while (i13 < size3) {
