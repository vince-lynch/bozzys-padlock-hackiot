...
public class SwitchCompat extends CompoundButton {
    ...
    private Layout makeLayout(CharSequence charSequence) {
        ...
        StaticLayout staticLayout = new StaticLayout(charSequence2, this.mTextPaint, charSequence2 != null ? (int) Math.ceil((double) Layout.getDesiredWidth(charSequence2, this.mTextPaint)) : 0, Alignment.ALIGN_NORMAL, 1.0f, 0.0f, true);
        return staticLayout;
    }
