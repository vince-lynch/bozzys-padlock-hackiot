...
public class FinderPatternFinder {
    ...
    private float crossCheckVertical(int i, int i2, int i3, int i4) {
        ...
        if (crossCheckStateCount2[4] >= i3 || Math.abs(((((crossCheckStateCount2[0] + crossCheckStateCount2[1]) + crossCheckStateCount2[2]) + crossCheckStateCount2[3]) + crossCheckStateCount2[4]) - i4) * 5 >= i4 * 2) {
            return Float.NaN;
        }
    ...
    private float crossCheckHorizontal(int i, int i2, int i3, int i4) {
        ...
        if (crossCheckStateCount2[4] >= i3 || Math.abs(((((crossCheckStateCount2[0] + crossCheckStateCount2[1]) + crossCheckStateCount2[2]) + crossCheckStateCount2[3]) + crossCheckStateCount2[4]) - i4) * 5 >= i4) {
            return Float.NaN;
        }
        if (foundPatternCross(crossCheckStateCount2)) {
            f = centerFromEnd(crossCheckStateCount2, i6);
