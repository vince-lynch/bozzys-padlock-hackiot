...
public final class Detector {
    ...
    private void extractParameters(ResultPoint[] resultPointArr) throws NotFoundException {
        ...
        for (int i2 = 0; i2 < 4; i2++) {
            ...
            if (this.compact) {
                j2 = j3 << 7;
                j = (long) ((i3 >> 1) & TransportMediator.KEYCODE_MEDIA_PAUSE);
            } else {
                j2 = j3 << 10;
    ...
    private BitMatrix sampleGrid(BitMatrix bitMatrix, ResultPoint resultPoint, ResultPoint resultPoint2, ResultPoint resultPoint3, ResultPoint resultPoint4) throws NotFoundException {
        ...
        return instance.sampleGrid(bitMatrix2, dimension, dimension, f2, f2, f3, f2, f3, f3, f2, f3, resultPoint.getX(), resultPoint.getY(), resultPoint2.getX(), resultPoint2.getY(), resultPoint3.getX(), resultPoint3.getY(), resultPoint4.getX(), resultPoint4.getY());
    }
