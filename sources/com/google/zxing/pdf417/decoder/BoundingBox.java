    ...
    public BoundingBox addMissingRows(int i, int i2, boolean z) throws NotFoundException {
        ...
        if (i > 0) {
            ...
            if (z) {
                ...
                calculateMinMaxValues();
                BoundingBox boundingBox2 = new BoundingBox(this.image, resultPoint2, resultPoint4, resultPoint, resultPoint3);
                return boundingBox2;
            }
        } else {
            resultPoint2 = resultPoint5;
        ...
        resultPoint3 = resultPoint8;
        calculateMinMaxValues();
        BoundingBox boundingBox22 = new BoundingBox(this.image, resultPoint2, resultPoint4, resultPoint, resultPoint3);
        return boundingBox22;
    }
