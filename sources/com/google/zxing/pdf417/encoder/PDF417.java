...
public final class PDF417 {
    ...
    public void generateBarcodeLogic(String str, int i) throws WriterException {
        ...
        if (errorCorrectionCodewordCount + length + 1 <= 929) {
            ...
            sb3.append(generateErrorCorrection);
            String sb4 = sb3.toString();
            this.barcodeMatrix = new BarcodeMatrix(i3, i2);
            encodeLowLevel(sb4, i2, i3, i, this.barcodeMatrix);
            return;
        }
        StringBuilder sb5 = new StringBuilder("Encoded message contains to many code words, message to big (");
        sb5.append(str.length());
        sb5.append(" bytes)");
        throw new WriterException(sb5.toString());
    }

    private int[] determineDimensions(int i, int i2) throws WriterException {
        float f = 0.0f;
        int[] iArr = null;
        for (int i3 = this.minCols; i3 <= this.maxCols; i3++) {
            int calculateNumberOfRows = calculateNumberOfRows(i, i2, i3);
            if (calculateNumberOfRows < this.minRows) {
                break;
            }
