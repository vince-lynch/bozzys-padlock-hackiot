...
public final class Detector {
    ...
    public DetectorResult detect() throws NotFoundException {
        ...
        ResultPoint resultPoint14 = !hashMap.containsKey(resultPoint3) ? resultPoint3 : !hashMap.containsKey(resultPoint4) ? resultPoint4 : !hashMap.containsKey(resultPoint5) ? resultPoint5 : resultPoint6;
        int transitions = transitionsBetween(resultPoint13, resultPoint14).getTransitions();
        int transitions2 = transitionsBetween(resultPoint11, resultPoint14).getTransitions();
        if ((transitions & 1) == 1) {
            transitions++;
        }
        int i = transitions + 2;
        ...
        if (i * 4 >= i2 * 7 || i2 * 4 >= i * 7) {
            ...
            ResultPoint correctTopRightRectangular = correctTopRightRectangular(resultPoint12, resultPoint11, resultPoint13, resultPoint14, i, i2);
            if (correctTopRightRectangular == null) {
                correctTopRightRectangular = resultPoint14;
            }
            ...
            bitMatrix = sampleGrid(this.image, resultPoint, resultPoint12, resultPoint11, resultPoint2, i3, transitions4);
        } else {
            resultPoint2 = correctTopRight(resultPoint12, resultPoint11, resultPoint13, resultPoint14, Math.min(i2, i));
            ...
            int i4 = max;
            bitMatrix = sampleGrid(this.image, resultPoint13, resultPoint12, resultPoint11, resultPoint2, i4, i4);
            resultPoint = resultPoint13;
        }
        return new DetectorResult(bitMatrix, new ResultPoint[]{resultPoint, resultPoint12, resultPoint11, resultPoint2});
    }
